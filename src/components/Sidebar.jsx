...
import { Activity, ChevronRight, Database, LayoutDashboard, LogOut, Send, ShieldAlert, WifiOff } from 'lucide-react'
...
const links = [
  ...
  { to: '/linkloss', label: 'Link Loss', icon: ShieldAlert, description: '400, 402 e 403 do Zabbix' },
